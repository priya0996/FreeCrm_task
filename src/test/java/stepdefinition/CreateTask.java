...
//	public void user_fill_the_fields_like(String Title, String Assigned_to, String Priority, String Status, String Description, String Identifier) throws Throwable {
//		driver.findElement(By.xpath("//*[@id=\\\"main-content\\\"]/div/div[2]/form/div[1]/div[1]/div/div/input")).sendKeys(Title);
//		driver.findElement(By.xpath("//*[@id=\\\"main-content\\\"]/div/div[2]/form/div[2]/div[1]/div/div")).sendKeys(Assigned_to);
//		driver.findElement(By.xpath("//*[@id=\\\"main-content\\\"]/div/div[2]/form/div[7]/div[1]/div/div")).sendKeys(Priority);
//		driver.findElement(By.xpath("//*[@id=\\\"main-content\\\"]/div/div[2]/form/div[7]/div[2]/div/div")).sendKeys(Status);
//		driver.findElement(By.xpath("//*[@id=\\\"main-content\\\"]/div/div[2]/form/div[6]/div[1]/div/textarea")).sendKeys(Description);
//		driver.findElement(By.xpath("//*[@id=\\\"main-content\\\"]/div/div[2]/form/div[8]/div/div/div/inpu")).sendKeys(Identifier);
//	}
//	
//	
//	
...
//	}/*
//	@Test(priority=13)
//	@When("^Users enters other field Title,Description,identifier and click on save$")
//	public void users_enters_other_field_Title_Description_identifier _and_click_on_save() throws Throwable {
//		CreateTaskPOM2 task1=PageFactory.initElements(driver, CreateTaskPOM2.class);
...
//		task1.titleText(Title);
//		String description=sheet1.getRow(0).getCell(1).getStringCellValue();
//		task1. decriptionText(description);
